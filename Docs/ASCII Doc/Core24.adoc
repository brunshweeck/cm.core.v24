...
*Core24* represente une version optimisée du système de fonction
standard lié au c++. Dans une vision, de lié toute les classe à une unique base, ainsi avoir une meilleur traçabilité.
****
