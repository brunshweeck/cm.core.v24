...
namespace core {
  namespace util {
    ...
    class Locale final : public Object {
       ...
       */
      class BaseLocale final : public Object {
        String language;
        String script;
        String region;
        String variant;

        static BaseLocale DEFAULT_LOCALE;
        static BaseLocale DEFAULT_DISPLAY_LOCALE;
        static BaseLocale DEFAULT_FORMAT_LOCALE;
        ...
        static void setDefault(gbool display, BaseLocale const& newLocale);
         ...
         *
         */
        static BaseLocale parse(String const& tag, gbool strict);
        ...
        static BaseLocale parseLocale(BaseLocale const& base);
       ...
       */
      CORE_EXPLICIT Locale(BaseLocale holder);
       ...
       * @param script An ISO 15924 alpha-6 script code
       ...
       */
      Locale(String language, String script, String country, String variant);
    ...
    public:
       ...
       * their current forms. See @em Legacy language codes for more information.
       *
       * @param language A language code. See the @c Locale class description of
       * @em language values.
       * @return A @c Locale object
       */
       ...
       * @param language A language code. See the @c Locale class description of
       * @em language values.
       * @param country A country code. See the @c Locale class description of
       * @em country values.
       */
       ...
       * This method normalizes the language value to lowercase,
       * script value to titlecase, and the country value to uppercase.
       * @note
       * Obsolete ISO 639 codes ("iw", "ji", and "in") are mapped to
       * their current forms. See @em Legacy language codes for more information.
       *
       * @param language A language code. See the @c Locale class description of
       * @em language values.
       * @param script A script code. See the @c Locale class description of
       * @em script value.
       * @param country A country code. See the @c Locale class description of
       * @em country values.
       * @throws IllformedLocaleException if any of all arguments is ill-formed
       */
       ...
       * @em country values.
       * @param variant Any arbitrary value used to indicate a variation of a @c Locale.
       * See the @c Locale class description of @em variant values.
       * @throws IllformedLocaleException if any of all arguments is ill-formed
       */
      static Locale of(String language, String script, String country, String variant);
    ...
    private:
      class LocaleParser final: public Object {};

      /**
       * @c LocaleBuilder is used to build instances of @c Locale
       * from values configured by the setters.  Unlike the @c Locale
       * constructors or @c Locale.of() factory methods,
       * the @c LocaleBuilder checks if a value configured by a
       * setter satisfies the syntax requirements defined by the @c Locale
       * class.  A @c Locale object obtained from a @c LocaleBuilder is
       * well-formed and can be transformed to a well-formed IETF BCP 47 language tag
       * without losing information.
       *
       * @implNote
       * The @c Locale class does not provide any
       * syntactic restrictions on variant, while BCP 47 requires each variant
       * subtag to be 5 to 8 alphanumerics or a single numeric followed by 3
       * alphanumerics.  The method @c setVariant throws
       * @c IllformedLocaleException for a variant that does not satisfy
       * this restriction. If it is necessary to support such a variant, use
       * @b Locale::of(String, String, String).  However, keep in mind that a @c Locale
       * object obtained this way might lose the variant information when
       * transformed to a BCP 47 language tag.
       *
       * <p>The following example shows how to obtain a @c Locale object
       * using a @c LocaleBuilder.
       * @code
       * auto lc = Locale::builder().setLanguage("sr").setScript("Latn").setRegion("RS").build();
       * @endcode
       ...
       */
      class LocalBuilder final: public Object {};
    };
  } // util
} // core
