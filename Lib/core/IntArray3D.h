...
#ifndef CORE24_INTARRAY3D_H
#define CORE24_INTARRAY3D_H

#include <core/IntArray2D.h>

namespace core {
    /**
     * The @c IntArray3D class wrap the 3-Dimensional array of gint.
     * It's the update and optimized form of primitive type @c gint[N][M][X].
     *
     * @see IntArray2D
     * @see IntArray
     */
    class IntArray3D final : public misc::PrimitiveArray<Integer>::Array3D<IntArray2D, IntArray> {
    public:
        /**
         * Construct new empty @c IntArray3D
         */
        CORE_IMPLICIT IntArray3D();

        /**
         * Construct new @c IntArray3D instance able to contains
         * the given number of rows.
         *
         * @note All rows will be initialized as empty @c IntArray2D
         *
         * @throws IllegalArgumentException If the given number of rows is negative
         * @param nbRows The number of rows to be allocated
         */
        CORE_EXPLICIT IntArray3D(gint nbRows);
         ...
         */
        CORE_EXPLICIT IntArray3D(gint nbRows, IntArray2D initializer);

        /**
         * Construct new @c IntArray3D instance able to contains
         * the given number of rows and columns.
         *
         * @note The content will be initialized as empty @c IntArray
         *
         * @throws IllegalArgumentException If the given length is negative
         ...
         *
         * @see IntArray2D(nbRows)
         */
        CORE_EXPLICIT IntArray3D(gint nbRows, gint nbCols);
         ...
         */
        CORE_EXPLICIT IntArray3D(gint nbRows, gint nbCols, IntArray initializer);
         ...
         */
        CORE_EXPLICIT IntArray3D(gint nbRows, gint nbCols, gint nbSubCols);
         ...
         */
        CORE_EXPLICIT IntArray3D(gint nbRows, gint nbCols, gint nbSubCols, gint initializer);

        /**
         * Construct new @c IntArray3D instance by copy of values
         * of given array.
         *
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT IntArray3D(IntArray3D const& array);

        /**
         * Construct new @c IntArray3D instance by swapping of content
         * of given array.
         *
         ...
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT IntArray3D(IntArray3D&& array) CORE_NOTHROW;

        /**
         * Construct new @c IntArray3D with specified rows
         * such that one rows is an instance of IntArray.
         * <p>
         * Example:
         * @code
         *  IntArray3D ia = {
         ...
         * @c IntArray3D::of(...) methods, And not do
         * implicit cast of values.
         *
         * @param args the list of rows used to create array.
         */
        CORE_IMPLICIT IntArray3D(VarArgs const& args);
         ...
         */
        IntArray2D& get(gint index) override;
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        IntArray2D const& get(gint index) const override;
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        IntArray2D set(gint index, IntArray2D newRow) override;
         ...
         */
        IntArray& get(gint ix, gint iy) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        IntArray const& get(gint ix, gint iy) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        IntArray set(gint ix, gint iy, IntArray newCol) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gint& get(gint ix, gint iy, gint iz) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gint const& get(gint ix, gint iy, gint iz) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gint set(gint ix, gint iy, gint iz, gint newValue) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        IntArray2D const& operator[](gint index) const;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        IntArray2D& operator[](gint index);
         ...
         */
        IntArray3D& operator=(IntArray3D const& array);
         ...
         * @return this array reference.
         */
        IntArray3D& operator=(IntArray3D&& array) CORE_NOTHROW;

        /**
         * Obtain newly created instance of @c IntArray3D initialized with zero rows
         *
         * @return empty int array
         */
        static IntArray3D of();

        /**
         * Obtain newly created instance of @c IntArray3D with single row
         *
         * @param r The first row
         */
        static IntArray3D of(IntArray2D const& r);

        /**
         * Obtain newly created instance of @c IntArray3D with two rows
         *
         * @param r0 The first row
         * @param r1 The second row
         */
        static IntArray3D of(IntArray2D const& r0, IntArray2D const& r1);

        /**
         * Obtain newly created instance of @c IntArray3D with three rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         */
        static IntArray3D of(IntArray2D const& r0, IntArray2D const& r1, IntArray2D const& r2);

        /**
         * Obtain newly created instance of @c IntArray3D with four rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with five rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with six rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with seven rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with eight rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with nine rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with ten rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray3D with ten and more rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        static IntArray3D of(IntArray2D const& r0, IntArray2D const& r1, IntArray2D const& r2,
                              IntArray2D const& r3, IntArray2D const& r4, IntArray2D const& r5,
                              IntArray2D const& r6, IntArray2D const& r7, IntArray2D const& r8,
                              IntArray2D const& r9, Rows&&... rs) {
            CORE_FAST_ASSERT(Class<>::allIsTrue<Class<IntArray2D>::accept<Rows>()...>());

            CORE_FAST gint n = sizeof...(Rows);
            gint wi = 10;

            IntArray3D ia = IntArray3D(10 + n);

            ia.initializeFirstTens(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            accumulate(ia.initialize(wi, CORE_CAST(Rows &&, rs))...);

            return ia;
        }

        /**
         * Obtain new IntArray3D instance from Array<IntArray>
         *
         * @param a the reference array 3D
         * @return the value array 3D
         */
        static IntArray3D copyOf(Array<IntArray2D> const& a);
    ...
    private:
        ...
        class Linear3DIterator final : public Object {
            ...
            CORE_EXPLICIT Linear3DIterator(IntArray3D& array, gbool isEnd);
        ...
        public:
            ...
            IntArray2D& operator*() const;

            gbool equals(const Object& o) const override;
        };

        class Linear3DIterator2 final : public Object {
            IntArray3D const& array;
            gint next = 0;
            gbool isEnd = false;

            CORE_ADD_AS_FRIEND(IntArray3D);

            CORE_EXPLICIT Linear3DIterator2(IntArray3D const& array, gbool isEnd);
        ...
        public:
            ...
            IntArray2D const& operator*() const;
    ...
    private:
        void initializeFirstTens(IntArray2D const& r0, IntArray2D const& r1, IntArray2D const& r2,
                                 IntArray2D const& r3, IntArray2D const& r4, IntArray2D const& r5,
                                 IntArray2D const& r6, IntArray2D const& r7, IntArray2D const& r8,
                                 IntArray2D const& r9) const;

        // ---------------------------- Varargs API ---------------------------------------------
        gint initialize(gint& i, IntArray2D const& r);
        gint initialize(gint& i, IntArray2D& r);
        gint initialize(gint& i, IntArray2D&& r);
