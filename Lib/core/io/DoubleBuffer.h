...
#ifndef CORE24_DOUBLEBUFFER_H
#define CORE24_DOUBLEBUFFER_H
...
namespace core {
    namespace io {
         ...
         *
         *
         *  @li <p> A method for compacting a double buffer.  </p>
         *
         * <p>
         ...
         * <p> Like a byte buffer, a double buffer is either
         * <a href="ByteBuffer.html#direct"><i>direct</i> or <i>non-direct</i></a>.  A
         * double buffer created via the @c wrap methods of this class will
         ...
         * on a @em read-only DoubleBuffer. The methods @em array and @em arrayOffset
         * throw an @em UnsupportedOperationException if the DoubleBuffer is
         * not backed by an <em> accessible double array</em>
         * (irrespective of whether the DoubleBuffer is read-only).
         * </p>
         */
        class DoubleBuffer : public virtual Buffer, public virtual Comparable<DoubleBuffer> {
        protected:
            /**
             ...
             * @param segment
             */
            CORE_EXPLICIT DoubleBuffer(gint mark, gint position, gint limit, gint capacity, Object& segment);
        ...
        public:
             ...
             */
            static DoubleBuffer& allocate(gint capacity);
             ...
             */
            static DoubleBuffer& wrap(DoubleArray& array, gint offset, gint length);
             ...
             * @return  The new double buffer
             */
            static DoubleBuffer& wrap(DoubleArray& array);
             ...
             * @return  The new double buffer
             */
            DoubleBuffer& slice() const override = 0;
             ...
             */
            DoubleBuffer& slice(gint index, gint length) const override = 0;
             ...
             * @return  The new double buffer
             */
            DoubleBuffer& duplicate() const override = 0;
             ...
             */
            virtual DoubleBuffer& put(gdouble c) = 0;
             ...
             */
            virtual gdouble get(gint index) const = 0;
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(gint index, gdouble c) = 0;
             ...
             * doubles are transferred and a @b BufferUnderflowException is
             * thrown.
             *
             * <p> Otherwise, this method copies @c length doubles from this
             ...
             *
             * @throws  BufferUnderflowException
             *          If there are fewer than @c length doubles
             ...
             *          parameters do not hold
             */
            virtual DoubleBuffer& get(DoubleArray& dst, gint offset, gint length);
             ...
             *          remaining in this buffer
             */
            virtual DoubleBuffer& get(DoubleArray& dst);

            /**
             * Absolute bulk <i>get</i> method.
             *
             * <p> This method transfers @c length doubles from this
             ...
             */
            virtual DoubleBuffer& get(gint index, DoubleArray& dst, gint offset, gint length);
             ...
             */
            virtual DoubleBuffer& get(gint index, DoubleArray& dst);
             ...
             * then no doubles are transferred and a @b BufferOverflowException is thrown.
             *
             * <p> Otherwise, this method copies
             * <i>n</i> = @c src.remaining() doubles from the given
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(DoubleBuffer& src);

            /**
             * Absolute bulk <i>put</i> method  <i>(optional operation)</i>.
             *
             * <p> This method transfers @c length doubles into this buffer from
             ...
             *         If this buffer is read-only
             */
            virtual DoubleBuffer& put(gint index, DoubleBuffer& src, gint offset, gint length);
             ...
             * @c length @c > @c remaining(), then no
             * doubles are transferred and a @b BufferOverflowException is
             * thrown.
             *
             * <p> Otherwise, this method copies @c length doubles from the
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(DoubleArray const& src, gint offset, gint length);
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(DoubleArray const& src);

            /**
             * Absolute bulk <i>put</i> method  <i>(optional operation)</i>.
             *
             * <p> This method transfers @c length doubles from the given
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(gint index, DoubleArray const& src, gint offset, gint length);

            /**
             * Absolute bulk <i>put</i> method  <i>(optional operation)</i>.
             *
             * <p> This method copies doubles into this buffer from the given source
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer& put(gint index, DoubleArray const& src);
             ...
             */
            DoubleArray& array() const override = 0;
            ...
            DoubleBuffer& position(gint newPosition) override;

            gint limit() const override;

            DoubleBuffer& limit(gint newLimit) override;

            DoubleBuffer& mark() override;

            DoubleBuffer& reset() override;

            DoubleBuffer& clear() override;

            DoubleBuffer& flip() override;

            DoubleBuffer& rewind() override;
             ...
             * double at index <i>p</i> = @c position() is copied
             ...
             * @c StringDoubleBuffer, which wraps a @c DoubleSequence, should
             ...
             * Pairs of @c gdouble elements are compared as if by invoking
             * @code Doubleacter::compare(gdouble,gdouble) @endcode .
             ...
             */
            gint compareTo(const DoubleBuffer& that) const override;
             ...
             */
            gint mismatch(DoubleBuffer const& that) const;

            /**
             * Returns a string containing the doubleacters in this buffer.
             *
             * <p> The first doubleacter of the resulting string will be the doubleacter at
             * this buffer's position, while the last doubleacter will be the doubleacter
        ...
        private:
            ...
            void getArray(gint index, DoubleArray& dst, gint offset, gint length) const;

            virtual DoubleBuffer& putArray(gint index, DoubleArray const& src, gint offset, gint length);

            virtual void putBuffer(gint pos, DoubleBuffer& src, gint srcPos, gint n);

            static DoubleArray& createHeap(gint heapSize);

            class HeapDoubleBuffer;
            class ReadOnlyHeapDoubleBuffer;
         ...
         */
        class DoubleBuffer::HeapDoubleBuffer : public DoubleBuffer {
            DoubleArray& hb;
            gint offset = 0;

            CORE_ADD_AS_FRIEND(ReadOnlyHeapDoubleBuffer);

        public:
            CORE_EXPLICIT HeapDoubleBuffer(gint cap, gint lim, Object& segment);

            CORE_EXPLICIT HeapDoubleBuffer(DoubleArray& buf, gint off, gint len, Object& segment);

            CORE_EXPLICIT HeapDoubleBuffer(DoubleArray& buf,
            ...
            DoubleBuffer& get(gint index, DoubleArray& dst, gint offset, gint length) override;
         ...
         */
        class DoubleBuffer::ReadOnlyHeapDoubleBuffer final : public HeapDoubleBuffer {
        public:
            CORE_EXPLICIT ReadOnlyHeapDoubleBuffer(gint cap, gint lim, Object& segment);

            CORE_EXPLICIT ReadOnlyHeapDoubleBuffer(DoubleArray& buf, gint off, gint len, Object& segment);

            CORE_EXPLICIT ReadOnlyHeapDoubleBuffer(DoubleArray& buf,
                                                   gint mark, gint pos, gint lim, gint cap, gint off, Object& segment);
