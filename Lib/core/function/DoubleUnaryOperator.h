...
#ifndef CORE24_DOUBLEUNARYOPERATOR_H
#define CORE24_DOUBLEUNARYOPERATOR_H
...
namespace core {
    namespace function {
        /**
         * Represents an operation on a single @c double - valued operand that produces
         * a @c double - valued result.  This is the primitive type specialization of
         * @c UnaryOperator for @c gdouble.
         * <p>
         * This is a functional interface whose functional method is @c DoubleUnaryOperator::apply.
         * </p>
         */
        class DoubleUnaryOperator final : public virtual Functional {
        ...
        protected:
             ...
             * by derived classes
             */
            CORE_IMPLICIT DoubleUnaryOperator() = default;
        ...
        public:
             ...
             *       class MyClass {
             *         public:
             *             static gdouble myStaticMethod(gdouble);
             *       };
             *
             *       DoubleUnaryOperator op1 = myFunction;
             *       DoubleUnaryOperator op2 = MyClass::myStaticMethod;
             *     @endcode
             * @li a <em> unary lambda function </em>;
             *      @code
             *        DoubleUnaryOperator op1 = [](gdouble) -> gdouble {...}
             *        DoubleUnaryOperator op2 = [&](gdouble) -> gdouble {...}
             *        DoubleUnaryOperator op3 = [=](gdouble) -> gdouble {...}
             *      @endcode
             ...
             *        };
             *
             *        DoubleUnaryOperator op = MyCallableClass(...);
             *      @endcode
             *
            ...
            template<class C,
                ...
                ClassOf(1)::OnlyIf<Class<Double>::accept<RT<C, Double> >()> CaptureReturn = 1>
            CORE_IMPLICIT DoubleUnaryOperator(C &&callable): DoubleUnaryOperator() {
             ...
             * class MyClass {
             *  public:
             *      gdouble myMethod(gdouble);
             * };
             *
             * DoubleUnaryOperator op = { MyClass(), &MyClass::myMethod };
             * @endcode
             *
            ...
            template<class O, class M,
                ...
                ClassOf(1)::OnlyIf<Class<Double>::accept<RT<M, O, Double> >()> CaptureReturn = 1>
            CORE_IMPLICIT DoubleUnaryOperator(O &&object, M method): DoubleUnaryOperator() {
                ...
                public:
                    ...
                    gdouble invoke(gdouble arg) const override {
            ...
            /**
             * Construct new instance of @c DoubleUnaryOperator with another consumer.
             *
             * @param other the consumer.
             */
            CORE_IMPLICIT DoubleUnaryOperator(DoubleUnaryOperator const &other) {
             ...
             */
            ~DoubleUnaryOperator() override {
                if (launcher && launcher->release() == 0) delete launcher;
                launcher = null;
            }

            DoubleUnaryOperator(DoubleUnaryOperator &&other) CORE_NOTHROW {
                UNSAFE::swapValues(launcher, other.launcher);
            }

            DoubleUnaryOperator &operator=(const DoubleUnaryOperator &other) {
                if (this != &other && other.launcher) {
                    if (launcher && launcher->release() == 0)
                        delete launcher;
                    launcher = other.launcher;
            ...
            DoubleUnaryOperator &operator=(DoubleUnaryOperator &&other) CORE_NOTHROW {
                if (this != &other)
                    UNSAFE::swapValues(launcher, other.launcher);
                return *this;
            }
             ...
             */
            gdouble apply(gdouble arg) const {
            ...
            gbool equals(const Object &obj) const override {
                return this == &obj ||
                       Class<DoubleUnaryOperator>::hasInstance(obj) &&
                       launcher == CORE_XCAST(DoubleUnaryOperator const, obj).launcher;
            }

            Object &clone() const override {
                try {
                    return UNSAFE::newInstance<DoubleUnaryOperator>(*this);
        ...
        private:
            ...
            public:
                virtual gdouble invoke(gdouble arg) const = 0;
            };
            ...
            public:
                ...
                gdouble invoke(gdouble arg) const override { return f(arg); }
            };
            ...
            public:
                ...
                gdouble invoke(gdouble arg) const override { return obj(arg); }
            };
        };
    } // function
} // core

#endif //CORE24_DOUBLEUNARYOPERATOR_H
