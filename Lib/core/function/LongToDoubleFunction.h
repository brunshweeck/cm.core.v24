...
#ifndef CORE24_LONGTODOUBLEFUNCTION_H
#define CORE24_LONGTODOUBLEFUNCTION_H
...
namespace core {
    namespace function {
         ...
         * double-valued result.  This is the @c long - to - @c double primitive
         * specialization for @c Function.
         * <p>
         * This is a functional interface whose functional method is @c LongToDoubleFunction::apply.
         * </p>
         */
        class LongToDoubleFunction final : public virtual Functional {
        ...
        protected:
            CORE_IMPLICIT LongToDoubleFunction() CORE_NOTHROW;
        ...
        public:
             ...
             *     @code
             *       gdouble myFunction(glong);
             *
             *       class MyClass {
             *         public:
             *             static gdouble myStaticMethod(glong);
             *       };
             *
             *       LongToDoubleFunction f1 = myFunction;
             *       LongToDoubleFunction f2 = MyClass::myStaticMethod;
             *     @endcode
             * @li a <em> unary lambda function </em>;
             *      @code
             *        LongToDoubleFunction f1 = [](glong) -> gdouble {...}
             *        LongToDoubleFunction f2 = [&](glong) -> gdouble {...}
             *        LongToDoubleFunction f3 = [=](glong) -> gdouble {...}
             *      @endcode
             * @li an <em>object that implement call operator with one argument </em>.
             *      @code
             *        class MyCallableClass {
             *        public:
             *          gdouble operator() (glong);
             *        };
             *
             *        LongToDoubleFunction f = MyCallableClass(...);
             *      @endcode
             *
            ...
            template<class C,
                ...
                ClassOf(1)::OnlyIf<Class<Double>::accept<RT<C, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongToDoubleFunction(C &&callable): LongToDoubleFunction() {
             ...
             * class MyClass {
             *  public:
             *      gdouble myMethod(glong);
             * };
             *
             * LongToDoubleFunction f = { MyClass(), &MyClass::myMethod };
             * @endcode
             *
            ...
            template<class O, class M,
                ...
                ClassOf(1)::OnlyIf<Class<Double>::accept<RT<M, O, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongToDoubleFunction(O &&object, M method): LongToDoubleFunction() {
                ...
                public:
                    ...
                    gdouble invoke(glong arg) const CORE_NOTHROW override {
             ...
             */
            CORE_IMPLICIT LongToDoubleFunction(LongToDoubleFunction const &other) {
             ...
             */
            ~LongToDoubleFunction() override {
                if (launcher && launcher->release() == 0) delete launcher;
                launcher = null;
            }

            LongToDoubleFunction(LongToDoubleFunction &&other) CORE_NOTHROW {
            UNSAFE::swapValues(launcher, other.launcher);
            }

            LongToDoubleFunction & operator=(const LongToDoubleFunction &other) {
                if (this != &other && other.launcher) {
                    if (launcher && launcher->release() == 0)
                        delete launcher;
                    launcher = other.launcher;
            ...
            LongToDoubleFunction & operator=(LongToDoubleFunction &&other) CORE_NOTHROW {
                if (this != &other)
                    UNSAFE::swapValues(launcher, other.launcher);
                return *this;
            }
            ...
            gbool equals(const Object &obj) const override {
                return this == &obj ||
                       Class<LongToDoubleFunction>::hasInstance(obj) &&
                       launcher == CORE_XCAST(LongToDoubleFunction const, obj).launcher;
            }

            Object &clone() const override {
                try {
                    return UNSAFE::newInstance<LongToDoubleFunction>(*this);
        ...
        private:
            ...
            public:
                virtual gdouble invoke(glong arg) const = 0;
            };
            ...
            public:
                ...
                gdouble invoke(glong arg) const  override { return f(arg); }
            };
            ...
            public:
                ...
                gdouble invoke(glong arg) const  override { return obj(arg); }
            };
        };
    } // function
} // core

#endif //CORE24_LONGTODOUBLEFUNCTION_H
