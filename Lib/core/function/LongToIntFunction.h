...
#ifndef CORE24_LONGTOINTFUNCTION_H
#define CORE24_LONGTOINTFUNCTION_H
...
namespace core {
    namespace function {
         ...
         * int-valued result.  This is the @c long - to - @c int primitive
         * specialization for @c Function.
         * <p>
         * This is a functional interface whose functional method is @c LongToIntFunction::apply.
         * </p>
         */
        class LongToIntFunction final : public virtual Functional {
        ...
        protected:
            CORE_IMPLICIT LongToIntFunction() CORE_NOTHROW;
        ...
        public:
             ...
             *     @code
             *       gint myFunction(glong);
             *
             *       class MyClass {
             *         public:
             *             static gint myStaticMethod(glong);
             *       };
             *
             *       LongToIntFunction f1 = myFunction;
             *       LongToIntFunction f2 = MyClass::myStaticMethod;
             *     @endcode
             * @li a <em> unary lambda function </em>;
             *      @code
             *        LongToIntFunction f1 = [](glong) -> gint {...}
             *        LongToIntFunction f2 = [&](glong) -> gint {...}
             *        LongToIntFunction f3 = [=](glong) -> gint {...}
             *      @endcode
             ...
             *        };
             *
             *        LongToIntFunction f = MyCallableClass(...);
             *      @endcode
             *
            ...
            template<class C,
                ...
                ClassOf(1)::OnlyIf<Class<Integer>::accept<RT<C, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongToIntFunction(C &&callable): LongToIntFunction() {
             ...
             * };
             *
             * LongToIntFunction f = { MyClass(), &MyClass::myMethod };
             * @endcode
             *
            ...
            template<class O, class M,
                ...
                ClassOf(1)::OnlyIf<Class<Integer>::accept<RT<M, O, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongToIntFunction(O &&object, M method): LongToIntFunction() {
                ...
                public:
                    ...
                    gint invoke(glong arg) const CORE_NOTHROW override {
             ...
             */
            CORE_IMPLICIT LongToIntFunction(LongToIntFunction const &other) {
             ...
             */
            ~LongToIntFunction() override {
                if (launcher && launcher->release() == 0) delete launcher;
                launcher = null;
            }

            LongToIntFunction(LongToIntFunction &&other) CORE_NOTHROW {
            UNSAFE::swapValues(launcher, other.launcher);
            }

            LongToIntFunction & operator=(const LongToIntFunction &other) {
                if (this != &other && other.launcher) {
                    if (launcher && launcher->release() == 0)
                        delete launcher;
                    launcher = other.launcher;
            ...
            LongToIntFunction & operator=(LongToIntFunction &&other) CORE_NOTHROW {
                if (this != &other)
                    UNSAFE::swapValues(launcher, other.launcher);
                return *this;
            }
            ...
            gbool equals(const Object &obj) const override {
                return this == &obj ||
                       Class<LongToIntFunction>::hasInstance(obj) &&
                       launcher == CORE_XCAST(LongToIntFunction const, obj).launcher;
            }

            Object &clone() const override {
                try {
                    return UNSAFE::newInstance<LongToIntFunction>(*this);
        ...
        private:
            ...
            public:
                virtual gint invoke(glong arg) const = 0;
            };
            ...
            public:
                ...
                gint invoke(glong arg) const  override { return f(arg); }
            };
            ...
            public:
                ...
                gint invoke(glong arg) const  override { return obj(arg); }
            };
        };
    } // function
} // core

#endif //CORE24_LONGTOINTFUNCTION_H
