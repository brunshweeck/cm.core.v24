...
#ifndef CORE24_LONGPREDICATE_H
#define CORE24_LONGPREDICATE_H
...
namespace core {
    namespace function {
        /**
         * Represents a predicate (boolean-valued function) of one @c long-valued
         * argument. This is the @c long-consuming primitive type specialization
         * of @c Predicate.
         */
        class LongPredicate final : public virtual Functional {
        ...
        protected:
             ...
             * by derived classes
             */
            CORE_IMPLICIT LongPredicate() = default;
        ...
        public:
             ...
             *       class MyClass {
             *         public:
             *             static gbool myStaticMethod(glong);
             *       };
             *
             *       LongPredicate p1 = myFunction;
             *       LongPredicate p2 = MyClass::myStaticMethod;
             *     @endcode
             * @li a <em> unary lambda function </em>;
             *      @code
             *        LongPredicate p1 = [](glong) -> gbool {...}
             *        LongPredicate p2 = [&](glong) -> gbool {...}
             *        LongPredicate p3 = [=](glong) -> gbool {...}
             *      @endcode
             ...
             *        };
             *
             *        LongPredicate p = MyCallableClass(...);
             *      @endcode
             *
            ...
            template<class C,
                ...
                ClassOf(1)::OnlyIf<Class<Boolean>::accept<RT<C, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongPredicate(C &&callable) {
             ...
             * class MyClass {
             *  public:
             *      gbool myMethod(glong);
             * };
             *
             * LongPredicate p = { MyClass(), &MyClass::myMethod };
             * @endcode
             *
            ...
            template<class O, class M,
                ...
                ClassOf(1)::OnlyIf<Class<Boolean>::accept<RT<M, O, Long> >()> CaptureReturn = 1>
            CORE_IMPLICIT LongPredicate(O &&object, M method): LongPredicate() {
                ...
                public:
                    ...
                    gbool invoke(glong arg) const CORE_NOTHROW override {
             ...
             */
            CORE_IMPLICIT LongPredicate(const LongPredicate &other) {
            ...
            ~LongPredicate() override {
                if (launcher && launcher->release() == 0) delete launcher;
                launcher = null;
            }

            LongPredicate(LongPredicate &&other) CORE_NOTHROW {
                UNSAFE::swapValues(launcher, other.launcher);
            }

            LongPredicate & operator=(const LongPredicate &other) {
                if (this != &other && other.launcher) {
                    if (launcher && launcher->release() == 0)
                        delete launcher;
                    launcher = other.launcher;
            ...
            LongPredicate & operator=(LongPredicate &&other) CORE_NOTHROW {
                if (this != &other)
                    UNSAFE::swapValues(launcher, other.launcher);
                return *this;
            }
             ...
             */
            LongPredicate logicalAnd(LongPredicate const &other) const {
                return [&](glong arg) -> glong { return test(arg) && other.test(arg); };
            }
             ...
             * predicate
             */
            LongPredicate negate() const {
                return [&](glong arg) -> gbool { return !test(arg); };
            }
             ...
             */
            LongPredicate logicalOr(LongPredicate const &other) const {
                return [&](glong arg) -> glong { return test(arg) || other.test(arg); };
            }

            gbool equals(const Object &obj) const override {
                return this == &obj ||
                       Class<LongPredicate>::hasInstance(obj) &&
                       launcher == CORE_XCAST(LongPredicate const, obj).launcher;
            }

            Object &clone() const override {
                try {
                    return UNSAFE::newInstance<LongPredicate>(*this);
        ...
        private:
            ...
            public:
                virtual gbool invoke(glong value) const = 0;
            };
            ...
            public:
                ...
                gbool invoke(glong value) const override { return f(value); }
            };
            ...
            public:
                ...
                gbool invoke(glong value) const override { return obj(value); }
            };
        };
    } // function
} // core

#endif //CORE24_LONGPREDICATE_H
