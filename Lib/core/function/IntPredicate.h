...
#ifndef CORE24_INTPREDICATE_H
#define CORE24_INTPREDICATE_H
...
namespace core {
    namespace function {
        /**
         * Represents a predicate (boolean-valued function) of one @c int-valued
         * argument. This is the @c int-consuming primitive type specialization
         * of @c Predicate.
         */
        class IntPredicate : public virtual Functional {
        ...
        protected:
             ...
             * by derived classes
             */
            CORE_IMPLICIT IntPredicate() = default;
        ...
        public:
             ...
             *       class MyClass {
             *         public:
             *             static gbool myStaticMethod(gint);
             *       };
             *
             *       IntPredicate p1 = myFunction;
             *       IntPredicate p2 = MyClass::myStaticMethod;
             *     @endcode
             * @li a <em> unary lambda function </em>;
             *      @code
             *        IntPredicate p1 = [](gint) -> gbool {...}
             *        IntPredicate p2 = [&](gint) -> gbool {...}
             *        IntPredicate p3 = [=](gint) -> gbool {...}
             *      @endcode
             ...
             *        };
             *
             *        IntPredicate p = MyCallableClass(...);
             *      @endcode
             *
            ...
            template<class C,
                ...
                ClassOf(1)::OnlyIf<Class<Boolean>::accept<RT<C, Integer> >()> CaptureReturn = 1>
            CORE_IMPLICIT IntPredicate(C &&callable) {
             ...
             * };
             *
             * IntPredicate p = { MyClass(), &MyClass::myMethod };
             * @endcode
             *
            ...
            template<class O, class M,
                ...
                ClassOf(1)::OnlyIf<Class<Boolean>::accept<RT<M, O, Integer> >()> CaptureReturn = 1>
            CORE_IMPLICIT IntPredicate(O &&object, M method): IntPredicate() {
                ...
                public:
                    ...
                    gbool invoke(gint arg) const CORE_NOTHROW override {
             ...
             */
            CORE_IMPLICIT IntPredicate(const IntPredicate &other) {
            ...
            ~IntPredicate() override {
                if (launcher && launcher->release() == 0) delete launcher;
                launcher = null;
            }

            IntPredicate(IntPredicate &&other) CORE_NOTHROW {
                UNSAFE::swapValues(launcher, other.launcher);
            }

            IntPredicate & operator=(const IntPredicate &other) {
                if (this != &other && other.launcher) {
                    if (launcher && launcher->release() == 0)
                        delete launcher;
                    launcher = other.launcher;
            ...
            IntPredicate & operator=(IntPredicate &&other) CORE_NOTHROW {
                if (this != &other)
                    UNSAFE::swapValues(launcher, other.launcher);
                return *this;
            }
             ...
             */
            virtual gbool test(gint value) const {
             ...
             */
            virtual IntPredicate logicalAnd(IntPredicate const &other) const {
                return [&](gint arg) -> gint { return test(arg) && other.test(arg); };
            }
             ...
             * predicate
             */
            virtual IntPredicate negate() const {
                return [&](gint arg) -> gbool { return !test(arg); };
            }
             ...
             */
            virtual IntPredicate logicalOr(IntPredicate const &other) const {
                return [&](gint arg) -> gint { return test(arg) || other.test(arg); };
            }

            gbool equals(const Object &obj) const override {
                return this == &obj ||
                       Class<IntPredicate>::hasInstance(obj) &&
                       launcher == CORE_XCAST(IntPredicate const, obj).launcher;
            }

            Object &clone() const override {
                try {
                    return UNSAFE::newInstance<IntPredicate>(*this);
        ...
        private:
            ...
            public:
                virtual gbool invoke(gint value) const = 0;
            };
            ...
            public:
                ...
                gbool invoke(gint value) const override { return f(value); }
            };
            ...
            public:
                ...
                gbool invoke(gint value) const override { return obj(value); }
            };
        };
    } // function
} // core

#endif //CORE24_INTPREDICATE_H
