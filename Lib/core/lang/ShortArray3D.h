...
#ifndef CORE24_SHORTARRAY3D_H
#define CORE24_SHORTARRAY3D_H

#include <core/lang/ShortArray2D.h>

namespace core {
    /**
     * The @c ShortArray3D class wrap the 3-Dimensional array of gshort.
     * It's the update and optimized form of primitive type @c gshort[N][M][X].
     *
     * @see ShortArray2D
     * @see ShortArray
     */
    class ShortArray3D final : public misc::PrimitiveArray<Short>::Array3D<ShortArray2D, ShortArray> {
    public:
        /**
         * Construct new empty @c ShortArray3D
         */
        CORE_IMPLICIT ShortArray3D();

        /**
         * Construct new @c ShortArray3D instance able to contains
         * the given number of rows.
         *
         * @note All rows will be initialized as empty @c ShortArray2D
         *
         * @throws IllegalArgumentException If the given number of rows is negative
         * @param nbRows The number of rows to be allocated
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows);
         ...
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows, ShortArray2D initializer);

        /**
         * Construct new @c ShortArray3D instance able to contains
         * the given number of rows and columns.
         *
         * @note The content will be initialized as empty @c ShortArray
         *
         * @throws IllegalArgumentException If the given length is negative
         ...
         *
         * @see ShortArray2D(nbRows)
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows, gint nbCols);
         ...
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows, gint nbCols, ShortArray initializer);
         ...
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows, gint nbCols, gint nbSubCols);
         ...
         */
        CORE_EXPLICIT ShortArray3D(gint nbRows, gint nbCols, gint nbSubCols, gshort initializer);

        /**
         * Construct new @c ShortArray3D instance by copy of values
         * of given array.
         *
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT ShortArray3D(ShortArray3D const& array);

        /**
         * Construct new @c ShortArray3D instance by swapping of content
         * of given array.
         *
         ...
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT ShortArray3D(ShortArray3D&& array) CORE_NOTHROW;

        /**
         * Construct new @c ShortArray3D with specified rows
         ...
         * @c ShortArray3D::of(...) methods, And not do
         * implicit cast of values.
         *
         * @param args the list of rows used to create array.
         */
        CORE_IMPLICIT ShortArray3D(VarArgs const& args);
         ...
         */
        ShortArray2D& get(gint index) override;
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        ShortArray2D const& get(gint index) const override;
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        ShortArray2D set(gint index, ShortArray2D newRow) override;
         ...
         */
        ShortArray& get(gint ix, gint iy) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        ShortArray const& get(gint ix, gint iy) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        ShortArray set(gint ix, gint iy, ShortArray newCol) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gshort& get(gint ix, gint iy, gint iz) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gshort const& get(gint ix, gint iy, gint iz) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gshort set(gint ix, gint iy, gint iz, gshort newValue) override;

        /**
         * Destroy this array
         */
        ~ShortArray3D() override;
        /**
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        ShortArray2D const& operator[](gint index) const;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        ShortArray2D& operator[](gint index);
         ...
         */
        ShortArray3D& operator=(ShortArray3D const& array);
         ...
         * @return this array reference.
         */
        ShortArray3D& operator=(ShortArray3D&& array) CORE_NOTHROW;

        /**
         * Obtain newly created instance of @c ShortArray3D initialized with zero rows
         *
         * @return empty short array
         */
        static ShortArray3D of();

        /**
         * Obtain newly created instance of @c ShortArray3D with single row
         *
         * @param r The first row
         */
        static ShortArray3D of(ShortArray2D const& r);

        /**
         * Obtain newly created instance of @c ShortArray3D with two rows
         *
         * @param r0 The first row
         * @param r1 The second row
         */
        static ShortArray3D of(ShortArray2D const& r0, ShortArray2D const& r1);

        /**
         * Obtain newly created instance of @c ShortArray3D with three rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         */
        static ShortArray3D of(ShortArray2D const& r0, ShortArray2D const& r1, ShortArray2D const& r2);

        /**
         * Obtain newly created instance of @c ShortArray3D with four rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with five rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with six rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with seven rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with eight rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with nine rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ShortArray3D with ten rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        static ShortArray3D of(ShortArray2D const& r0, ShortArray2D const& r1, ShortArray2D const& r2,
                              ...
                              ShortArray2D const& r9);

        /**
         * Obtain newly created instance of @c ShortArray3D with ten and more rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        static ShortArray3D of(ShortArray2D const& r0, ShortArray2D const& r1, ShortArray2D const& r2,
                              ShortArray2D const& r3, ShortArray2D const& r4, ShortArray2D const& r5,
                              ShortArray2D const& r6, ShortArray2D const& r7, ShortArray2D const& r8,
                              ShortArray2D const& r9, Rows&&... rs) {
            CORE_FAST_ASSERT(Class<>::allIsTrue<Class<ShortArray2D>::accept<Rows>()...>());

            CORE_FAST gint n = sizeof...(Rows);
            gint wi = 10;

            ShortArray3D sa = ShortArray3D(10 + n);

            sa.initializeFirstTens(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            accumulate(sa.initialize(wi, CORE_CAST(Rows &&, rs))...);

            return sa;
        }

        /**
         * Obtain new ShortArray3D instance from Array<ShortArray>
         *
         * @param a the reference array 3D
         * @return the value array 3D
         */
        static ShortArray3D copyOf(Array<ShortArray2D> const& a);
    ...
    private:
        ...
        class Linear3DIterator final : public Object {
            ...
            CORE_EXPLICIT Linear3DIterator(ShortArray3D& array, gbool isEnd);
        ...
        public:
            ...
            ShortArray2D& operator*() const;

            gbool equals(const Object& o) const override;
        };

        class Linear3DIterator2 final : public Object {
            ShortArray3D const& array;
            gint next = 0;
            gbool isEnd = false;

            CORE_ADD_AS_FRIEND(ShortArray3D);

            CORE_EXPLICIT Linear3DIterator2(ShortArray3D const& array, gbool isEnd);
        ...
        public:
            ...
            ShortArray2D const& operator*() const;
    ...
    private:
        void initializeFirstTens(ShortArray2D const& r0, ShortArray2D const& r1, ShortArray2D const& r2,
                                 ShortArray2D const& r3, ShortArray2D const& r4, ShortArray2D const& r5,
                                 ShortArray2D const& r6, ShortArray2D const& r7, ShortArray2D const& r8,
                                 ShortArray2D const& r9) const;

        // ---------------------------- Varargs API ---------------------------------------------
        gint initialize(gint& i, ShortArray2D const& r);
        gint initialize(gint& i, ShortArray2D& r);
        gint initialize(gint& i, ShortArray2D&& r);
