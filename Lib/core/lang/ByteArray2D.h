...
#ifndef CORE24_BYTEARRAY2D_H
#define CORE24_BYTEARRAY2D_H

#include <core/lang/ByteArray.h>

namespace core {
    /**
     * The @c ByteArray class wrap the 2-Dimensional array of @c gbyte. it's
     * the update and optimized form of primitive type @c gbyte[N][M].
     */
    class ByteArray2D final
        : public misc::PrimitiveArray<Byte>::Array2D<ByteArray> {
    public:
        /**
         * Construct new empty @c ByteArray2D
         */
        CORE_IMPLICIT ByteArray2D();

        /**
         * Construct new @c ByteArray2D instance able to contains
         * the given number of rows. The row of this array represent
         * another array (@c ByteArray), And all rows will be initializer
         * as empty array.
         *
         * @throws IllegalArgumentException If the given length is negative
         * @param nbRows The number of rows to be allocated
         */
        CORE_EXPLICIT ByteArray2D(gint nbRows);
         ...
         */
        CORE_EXPLICIT ByteArray2D(gint nbRows, ByteArray initializer);
         ...
         */
        CORE_EXPLICIT ByteArray2D(gint nbRows, gint nbCols);
         ...
         */
        CORE_EXPLICIT ByteArray2D(gint nbRows, gint nbCols, gbyte initializer);

        /**
         * Construct new @c ByteArray2D instance by copy of values
         * of given array.
         *
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT ByteArray2D(ByteArray2D const& array);

        /**
         * Construct new @c ByteArray2D instance by swapping of content
         * of given array.
         *
         ...
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT ByteArray2D(ByteArray2D&& array) CORE_NOTHROW;

        /**
         * Construct new @c ByteArray2D with specified list of rows
         ...
         * @c ByteArray2D::of(...) methods, And not do
         * implicit cast of values.
         *
         * @param args the list of rows used to create array.
         */
        CORE_IMPLICIT ByteArray2D(VarArgs const& args);
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        ByteArray set(gint index, ByteArray newRow) override;
         ...
         */
        gbyte& get(gint ix, gint iy) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gbyte const& get(gint ix, gint iy) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gbyte set(gint ix, gint iy, gbyte newValue) override;

        /**
         * Destroy this array
         */
        ~ByteArray2D() override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        ByteArray const& operator[](gint index) const;
         ...
         */
        ByteArray2D& operator=(ByteArray2D const& array);
         ...
         * @return this array reference.
         */
        ByteArray2D& operator=(ByteArray2D&& array) CORE_NOTHROW;

        /**
         * Obtain newly created instance of @c ByteArray2D initialized with zero rows
         *
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with single row
         *
         * @param r The first row
         */
        static ByteArray2D of(ByteArray const& r);

        /**
         * Obtain newly created instance of @c ByteArray2D initialized with two rows
         *
         * @param r0 The first row
         * @param r1 The second row
         */
        static ByteArray2D of(ByteArray const& r0, ByteArray const& r1);

        /**
         * Obtain newly created instance of @c ByteArray2D initialized with three rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         */
        static ByteArray2D of(ByteArray const& r0, ByteArray const& r1, ByteArray const& r2);

        /**
         * Obtain newly created instance of @c ByteArray2D initialized with four rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         ...
         */
        static ByteArray2D of(ByteArray const& r0, ByteArray const& r1, ByteArray const& r2, ByteArray const& r3);

        /**
         * Obtain newly created instance of @c ByteArray2D initialized with five rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with six rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with seven rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with eight rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with nine rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with ten rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c ByteArray2D initialized with ten and more rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        static ByteArray2D of(ByteArray const& r0, ByteArray const& r1, ByteArray const& r2, ByteArray const& r3,
                              ByteArray const& r4, ByteArray const& r5, ByteArray const& r6, ByteArray const& r7,
                              ByteArray const& r8, ByteArray const& r9, Rows&&... rows) {
            CORE_FAST_ASSERT(Class<>::allIsTrue<Class<ByteArray>::isSame<Rows>()...>());

            CORE_FAST gint n = sizeof...(Rows);
            gint wi = 10;

            ByteArray2D ba = ByteArray2D(10 + n);
        ...
        /**
         * Obtain new ByteArray2D instance from Array<ByteArray>
         *
         * @param a the reference array 2D
         * @return the value array 2D
         */
     static ByteArray2D copyOf(Array<ByteArray> const& a);
    ...
    private:
     ...
     class Linear2DIterator final : public Object {
      ...
      CORE_EXPLICIT Linear2DIterator(ByteArray2D& array, gbool isEnd);
     ...
     class Linear2DIterator2 final : public Object {
      ByteArray2D const& array;
      gint next = 0;
      gbool isEnd = false;

      CORE_ADD_AS_FRIEND(ByteArray2D);

      CORE_EXPLICIT Linear2DIterator2(ByteArray2D const& array, gbool isEnd);
     ...
     public:
      ...
      ByteArray const& operator*() const;
    ...
    private:
        void initializeFirstTens(ByteArray const& r0, ByteArray const& r1, ByteArray const& r2, ByteArray const& r3,
                                 ByteArray const& r4, ByteArray const& r5, ByteArray const& r6, ByteArray const& r7,
                                 ByteArray const& r8, ByteArray const& r9);

        // ---------------------------- Varargs API ---------------------------------------------
        gint initialize(gint& i, ByteArray const& r);
        gint initialize(gint& i, ByteArray& r);
        gint initialize(gint& i, ByteArray&& r);
