...
#ifndef CORE24_INTARRAY2D_H
#define CORE24_INTARRAY2D_H

#include <core/lang/IntArray.h>

namespace core {
    /**
     * The @c IntArray class wrap the 2-Dimensional array of @c gint. it's
     * the update and optimized form of primitive type @c gint[N][M].
     */
    class IntArray2D final
        : public misc::PrimitiveArray<Integer>::Array2D<IntArray> {
    public:
        /**
         * Construct new empty @c IntArray2D
         */
        CORE_IMPLICIT IntArray2D();

        /**
         * Construct new @c IntArray2D instance able to contains
         * the given number of rows. The row of this array represent
         * another array (@c IntArray), And all rows will be initializer
         * as empty array.
         *
         * @throws IllegalArgumentException If the given length is negative
         * @param nbRows The number of rows to be allocated
         */
        CORE_EXPLICIT IntArray2D(gint nbRows);
         ...
         */
        CORE_EXPLICIT IntArray2D(gint nbRows, IntArray initializer);
         ...
         */
        CORE_EXPLICIT IntArray2D(gint nbRows, gint nbCols);
         ...
         */
        CORE_EXPLICIT IntArray2D(gint nbRows, gint nbCols, gint initializer);

        /**
         * Construct new @c IntArray2D instance by copy of values
         * of given array.
         *
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT IntArray2D(IntArray2D const& array);

        /**
         * Construct new @c IntArray2D instance by swapping of content
         * of given array.
         *
         ...
         * @param array The array used to create this array.
         */
        CORE_IMPLICIT IntArray2D(IntArray2D&& array) CORE_NOTHROW;

        /**
         * Construct new @c IntArray2D with specified list of rows
         ...
         * @c IntArray2D::of(...) methods, And not do
         * implicit cast of values.
         *
         * @param args the list of rows used to create array.
         */
        CORE_IMPLICIT IntArray2D(VarArgs const& args);
         ...
         * @throws IndexOutOfBoundsException If the given index out of bounds
         */
        IntArray set(gint index, IntArray newRow) override;
         ...
         */
        gint& get(gint ix, gint iy) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gint const& get(gint ix, gint iy) const override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        gint set(gint ix, gint iy, gint newValue) override;
         ...
         * @throws IndexOutOfBoundsException If one of the given index out of bounds
         */
        IntArray const& operator[](gint index) const;
         ...
         */
        IntArray2D& operator=(IntArray2D const& array);
         ...
         * @return this array reference.
         */
        IntArray2D& operator=(IntArray2D&& array) CORE_NOTHROW;

        /**
         * Obtain newly created instance of @c IntArray2D initialized with zero rows
         *
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with single row
         *
         * @param r The first row
         */
        static IntArray2D of(IntArray const& r);

        /**
         * Obtain newly created instance of @c IntArray2D initialized with two rows
         *
         * @param r0 The first row
         * @param r1 The second row
         */
        static IntArray2D of(IntArray const& r0, IntArray const& r1);

        /**
         * Obtain newly created instance of @c IntArray2D initialized with three rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         */
        static IntArray2D of(IntArray const& r0, IntArray const& r1, IntArray const& r2);

        /**
         * Obtain newly created instance of @c IntArray2D initialized with four rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
         ...
         */
        static IntArray2D of(IntArray const& r0, IntArray const& r1, IntArray const& r2, IntArray const& r3);

        /**
         * Obtain newly created instance of @c IntArray2D initialized with five rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with six rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with seven rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with eight rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with nine rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with ten rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        /**
         * Obtain newly created instance of @c IntArray2D initialized with ten and more rows
         *
         * @param r0 The first row
         * @param r1 The second row
         * @param r2 The third row
        ...
        static IntArray2D of(IntArray const& r0, IntArray const& r1, IntArray const& r2, IntArray const& r3,
                              IntArray const& r4, IntArray const& r5, IntArray const& r6, IntArray const& r7,
                              IntArray const& r8, IntArray const& r9, Rows&&... rows) {
            CORE_FAST_ASSERT(Class<>::allIsTrue<Class<IntArray>::isSame<Rows>()...>());

            CORE_FAST gint n = sizeof...(Rows);
            gint wi = 10;

            IntArray2D ia = IntArray2D(10 + n);

            ia.initializeFirstTens(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            accumulate(ia.initialize(wi, CORE_CAST(Rows &&, rows))...);

            return ia;
        }

        /**
         * Obtain new IntArray2D instance from Array<IntArray>
         *
         * @param a the reference array 2D
         * @return the value array 2D
         */
     static IntArray2D copyOf(Array<IntArray> const& a);
    ...
    private:
     ...
     class Linear2DIterator final : public Object {
      ...
      CORE_EXPLICIT Linear2DIterator(IntArray2D& array, gbool isEnd);
     ...
     class Linear2DIterator2 final : public Object {
      IntArray2D const& array;
      gint next = 0;
      gbool isEnd = false;

      CORE_ADD_AS_FRIEND(IntArray2D);

      CORE_EXPLICIT Linear2DIterator2(IntArray2D const& array, gbool isEnd);
    ...
    private:
        void initializeFirstTens(IntArray const& r0, IntArray const& r1, IntArray const& r2, IntArray const& r3,
                                 IntArray const& r4, IntArray const& r5, IntArray const& r6, IntArray const& r7,
                                 IntArray const& r8, IntArray const& r9);

        // ---------------------------- Varargs API ---------------------------------------------
        gint initialize(gint& i, IntArray const& r);
        gint initialize(gint& i, IntArray& r);
        gint initialize(gint& i, IntArray&& r);
