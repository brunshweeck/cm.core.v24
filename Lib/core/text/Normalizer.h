...
#ifndef CORE24_NORMALIZER_H
#define CORE24_NORMALIZER_H
...
namespace core {
    namespace text {
        /**
         * This class provides the method @c normalize which transforms Unicode
         * text into an equivalent composed or decomposed form, allowing for easier
         * sorting and searching of text.
         * The @c normalize method supports the standard normalization forms
         * described in
         ...
         * <p>
         * The @c normalize method helps solve these problems by transforming
         * text into the canonical composed and decomposed forms as shown in the first
         * example above. In addition, you can have it perform compatibility
         * decompositions so that you can treat compatibility characters the same as
         * their equivalents.
         * Finally, the @c normalize method rearranges accents into the
         ...
         */
        class Normalizer final : public Object {
            CORE_IMPLICIT Normalizer() = default;
        ...
        public:
             ...
             *                   @b Normalizer::Form#NFC,
             *                   @b Normalizer::Form#NFD,
             *                   @b Normalizer::Form#NFKC,
             *                   @b Normalizer::Form#NFKD
             * @return The normalized String
             */
            static String normalize(CharSequence const& src, Form form);
             ...
             *          false otherwise.
             */
            static gbool isNormalized(CharSequence const& src, Form form);
        };
    } // text
} // core

#endif //CORE24_NORMALIZER_H
