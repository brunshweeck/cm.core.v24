...
namespace core {
  namespace time {
     ...
     */
    class LocalTime final : public virtual TemporalBase<LocalTime>,
                            public virtual TemporalAdjuster,
                            public virtual Comparable<LocalTime> {
    ...
    private:
       ...
       */
      LocalTime(gint hour, gint minute, gint second, gint nanoOfSecond);
    ...
    public:
       ...
       */
      static LocalTime of(gint hour, gint minute);
       ...
       * @throws DateTimeException if the value of any field is out of range
       */
      static LocalTime of(gint hour, gint minute, gint second);
       ...
       * @throws DateTimeException if the value of any field is out of range
       */
      static LocalTime of(gint hour, gint minute, gint second, gint nanoOfSecond);

      /**
       * Obtains an instance of @c LocalTime from an @c Instant and zone ID.
       * <p>
       ...
       *
       * @param instant  the instant to create the time from
       * @param zone  the time-zone, which may be an offset
       * @return the local time
       */
      static LocalTime ofInstant(Instant const& instant, ZoneId const& zone);
       ...
       * <p>
       * The conversion uses the @b TemporalQueries::localTime() query, which relies
       ...
       */
      static LocalTime from(TemporalAccessor const& temporal);

      /**
       * Obtains an instance of @c LocalTime from a text string such as @c 10:15.
       * <p>
       * The string must represent a valid time and is parsed using
       * @b DateTimeFormatter::ISO_LOCAL_TIME.
       *
       * @param text  the text to parse such as "10:15:30"
       * @return the parsed local time
       * @throws DateTimeParseException if the text cannot be parsed
       */
      static LocalTime parse(CharSequence const& text);

      /**
       * Obtains an instance of @c LocalTime from a text string using a specific formatter.
       * <p>
       ...
       * @throws DateTimeParseException if the text cannot be parsed
       */
      static LocalTime parse(CharSequence const& text, DateTimeFormatter const& formatter);
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime with(TemporalAdjuster const& adjuster) const override;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime with(TemporalField field, glong newValue) const override;
       ...
       * <p>
       * This returns a @c LocalTime, based on this one, with the specified amount added.
       ...
       * @return a @c LocalTime based on this time with the addition made
       * @throws DateTimeException if the addition cannot be made
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime plus(TemporalAmount const& amountToAdd) const override;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime plus(glong amountToAdd, TemporalUnit unit) const override;
       ...
       * <p>
       * This returns a @c LocalTime, based on this one, with the specified amount subtracted.
       * The amount is typically @b Duration but may be any other type implementing
       * the @b TemporalAmount interface.
       * <p>
       * The calculation is delegated to the amount object by calling
       ...
       * @return a @c LocalTime based on this time with the subtraction made
       * @throws DateTimeException if the subtraction cannot be made
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime minus(TemporalAmount const& amountToSubtract) const override;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      LocalTime minus(glong amountToSubtract, TemporalUnit unit) const override;
      ...
      /**
       * Combines this time with an offset to create an @c OffsetTime.
       * <p>
       * This returns an @c OffsetTime formed from this time at the specified offset.
       * All possible combinations of time and offset are valid.
       *
       * @param offset  the offset to combine with
       * @return the offset time formed from this time and the specified offset
       */
      OffsetTime atOffset(ZoneOffset const& offset) const;
    ...
    private:
       ...
       * @return the local time
       */
      static LocalTime create(gint hour, gint minute, gint second, gint nanoOfSecond);
    };
  } // time
} // core
