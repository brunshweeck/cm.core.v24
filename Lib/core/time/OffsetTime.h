...
namespace core {
    namespace time {
         ...
         * </p>
         */
        class OffsetTime final : public virtual Temporal, public virtual Comparable<OffsetTime> {
        public:
            /**
        ...
        public:
             ...
             */
            CORE_EXPLICIT OffsetTime(LocalTime const& time, ZoneOffset const& offset);

            /**
             * Obtains an instance of @c OffsetTime from an hour and minute.
             * <p>
             ...
             */
            CORE_EXPLICIT OffsetTime(gint hour, gint minute, ZoneOffset const& offset);

            /**
             * Obtains an instance of @c OffsetTime from an hour, minute and second.
             * <p>
             * This creates an offset time with the four specified fields.
             * </p>
             * <p>
             ...
             * @throws DateTimeException if the value of any field is out of range
             */
            CORE_EXPLICIT OffsetTime(gint hour, gint minute, gint second, ZoneOffset const& offset);
             ...
             * @throws DateTimeException if the value of any field is out of range
             */
            CORE_EXPLICIT OffsetTime(gint hour, gint minute, gint second, gint nanoOfSecond, ZoneOffset const& offset);
             ...
             */
            static OffsetTime from(Temporal const& temporal);
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetTime with(ChronoField field, glong newValue) const;
             ...
             */
            OffsetTime truncateTo(ChronoUnit unit) const;
             ...
             * @b LocalTime::plus(long, ChronoUnit).
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetTime plus(glong amountToAdd, ChronoUnit unit) const;
             ...
             */
            OffsetTime plusNanos(gint nanos) const;
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetTime minus(glong amountToSubtract, ChronoUnit unit) const;
             ...
             * use @b ChronoField#NANO_OF_DAY as a comparator.
             * </p>
