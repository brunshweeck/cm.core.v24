...
namespace core {
  namespace time {
     ...
     */
    class ZonedDateTime final : public virtual TemporalBase<ZonedDateTime>,
                                public virtual Comparable<ZonedDateTime> {
       ...
       */
      ZonedDateTime(LocalDateTime const& dateTime, ZoneOffset const& offset, ZoneId const& zone);
    ...
    public:
       ...
       */
      static ZonedDateTime of(LocalDate const& date, LocalTime const& time, ZoneId const& zone);
       ...
       */
      static ZonedDateTime of(LocalDateTime const& dateTime, ZoneId const& zone);
       ...
       */
      static ZonedDateTime of(gint year, gint month, gint dayOfMonth,
       ...
       * The valid offset is used, typically corresponding to "summer".
       * </p>
       * <p>
       ...
       * @param dateTime  the local date-time
       * @param zone  the time-zone
       * @param preferredOffset  the zone offset
       * @return the zoned date-time
       */
      static ZonedDateTime ofLocal(LocalDateTime const& dateTime,
                                   ZoneId const& zone, ZoneOffset const& preferredOffset);
       ...
       */
      static ZonedDateTime ofInstant(Instant const& instant, ZoneId const& zone);
       ...
       */
      static ZonedDateTime from(TemporalAccessor const& temporal);
       ...
       */
      static ZonedDateTime parse(CharSequence const& text);
       ...
       * @throws DateTimeParseException if the text cannot be parsed
       */
      static ZonedDateTime parse(CharSequence const& text, DateTimeFormatter const& formatter);
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      ZonedDateTime with(TemporalAdjuster const& adjuster) const override;
       ...
       */
      ZonedDateTime truncatedTo(TemporalUnit unit) const;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      ZonedDateTime plus(TemporalAmount const& amountToAdd) const override;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      ZonedDateTime plus(glong amountToAdd, TemporalUnit unit) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusYears(glong years) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusMonths(glong months) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusWeeks(glong weeks) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusDays(glong days) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusHours(glong hours) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusMinutes(glong minutes) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusSeconds(glong seconds) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime plusNanos(glong nanos) const;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      ZonedDateTime minus(TemporalAmount const& amountToSubtract) const override;
       ...
       * @throws ArithmeticException if numeric overflow occurs
       */
      ZonedDateTime minus(glong amountToSubtract, TemporalUnit unit) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusYears(glong years) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusMonths(glong months) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusWeeks(glong weeks) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusDays(glong days) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusHours(glong hours) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusMinutes(glong minutes) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusSeconds(glong seconds) const;
       ...
       * @throws DateTimeException if the result exceeds the supported date range
       */
      ZonedDateTime minusNanos(glong nanos) const;
