...
namespace core {
    namespace time {
         ...
         * </p>
         */
        class ZoneId : public virtual Temporal {
            CORE_ADD_AS_FRIEND(ZonedDateTime);

        protected:
            /**
             * Constructor only accessible by subclass.
             */
            ZoneId() = default;
        ...
        public:
             ...
             */
            static ZoneId const &getDefault();
             ...
             */
            static util::Set<String> const& availableZoneIds();
             ...
             */
            static ZoneId const& from(Temporal const& temporal);
        ...
        private:
             ...
             * @throws DateTimeException if the zone ID has an invalid format
             */
            static ZoneId const &ofWithPrefix(const String& zoneId, int prefixLength, gbool checkAvailable);
