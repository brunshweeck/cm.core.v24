...
namespace core {
    namespace time {
         ...
         * </p>
         */
        class OffsetDateTime final : public virtual Temporal, public virtual Comparable<OffsetDateTime> {
        public:
            /**
        ...
        public:
             ...
             */
            CORE_EXPLICIT OffsetDateTime(LocalDate const& date, LocalTime const& time, ZoneOffset const& offset);
             ...
             * @return the offset date-time
             */
            CORE_EXPLICIT OffsetDateTime(LocalDateTime const& dateTime, ZoneOffset const& offset);

            /**
             * Obtains an instance of @c OffsetDateTime from a year, month, day,
             * hour, minute and offset.
             * <p>
             ...
             */
            CORE_EXPLICIT OffsetDateTime(gint year, gint month, gint dayOfMonth,
             ...
             */
            static OffsetDateTime from(Temporal const& temporal);
             ...
             * If false, then calling the @b plus(long, ChronoUnit) and
             * @b minus(long, ChronoUnit) methods will throw an exception.
             * </p>
             * <p>
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetDateTime with(ChronoField field, glong newValue) const;
             ...
             */
            OffsetDateTime truncateTo(ChronoUnit unit) const;
             ...
             * </p>
             * <p>
             * If the field is a @b ChronoUnit then the addition is implemented by
             * @b LocalDateTime::plus(long, ChronoUnit).
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetDateTime plus(glong amountToAdd, ChronoUnit unit) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusYears(gint years) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusMonths(gint months) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusWeeks(gint weeks) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusDays(gint days) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusHours(gint hours) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusMinutes(gint minutes) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime plusSeconds(gint seconds) const;
             ...
             */
            OffsetDateTime plusNanos(gint nanos) const;
             ...
             * @throws ArithmeticException if numeric overflow occurs
             */
            OffsetDateTime minus(glong amountToSubtract, ChronoUnit unit) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusYears(gint years) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusMonths(gint months) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusWeeks(gint weeks) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusDays(gint days) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusHours(gint hours) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusMinutes(gint minutes) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusSeconds(gint seconds) const;
             ...
             * @throws DateTimeException if the result exceeds the supported date range
             */
            OffsetDateTime minusNanos(gint nanos) const;
             ...
             *
             * @li @c 2008-12-03T10:30+01:00
             * @li @c 2008-12-03T11:00+01:00
             * @li @c 2008-12-03T12:00+02:00
             * @li @c 2008-12-03T11:30+01:00
             * @li @c 2008-12-03T12:00+01:00
             * @li @c 2008-12-03T12:30+01:00
             * </p>
             ...
             *
             * @li @c uuuu-MM-dd'T'HH:mmXXXXX
             * @li @c uuuu-MM-dd'T'HH:mm:ssXXXXX
             * @li @c uuuu-MM-dd'T'HH:mm:ss.SSSXXXXX
             * @li @c uuuu-MM-dd'T'HH:mm:ss.SSSSSSXXXXX
             * @li @c uuuu-MM-dd'T'HH:mm:ss.SSSSSSSSSXXXXX
             * </p>
