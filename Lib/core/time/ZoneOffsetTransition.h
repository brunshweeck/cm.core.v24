...
namespace core {
    namespace time {
        ...
        class ZoneOffsetTransition final : public Comparable<ZoneOffsetTransition> {
             ...
             */
            CORE_EXPLICIT ZoneOffsetTransition(glong epochSecond,
        ...
        public:
             ...
             */
            CORE_EXPLICIT ZoneOffsetTransition(LocalDateTime const& transition,
                                               ZoneOffset const& offsetBefore,
                                               ZoneOffset const& offsetAfter);
        ...
        private:
             ...
             */
            util::List<ZoneOffset>& validOffsets() const;
        };
    } // time
} // core
