...
namespace core {
    namespace concurrent {
        ...
        public:
             ...
             * <b> tryAcquire(0, ChronoUnit::SECONDS) </b>
             ...
             * @throws InterruptedException if the current thread is interrupted
             */
            virtual gbool tryAcquire(glong timeout, time::Temporal::ChronoUnit unit);
             ...
             * tryAcquire(permits, 0, ChronoUnit::SECONDS) </b>
             * which is almost equivalent (it also detects interruption).
             * </p>
             * @param permits the number of permits to acquire
             ...
             * @throws IllegalArgumentException if @c permits is negative
             */
            virtual gbool tryAcquire(gint permits, glong timeout, time::Temporal::ChronoUnit unit);
