...
#ifndef L128X1024MIXRANDOM_H
#define L128X1024MIXRANDOM_H
...
namespace core {
    namespace random {
         ...
         * is roughly 2<sup>256</sup>.  Class @b L128X1024MixRandom implements
         ...
         * as well as methods for creating new split-off @b L128X1024MixRandom
         * objects or streams of such objects.
         *
         * <p>
         * The @b L128X1024MixRandom algorithm is a specific member of
         * the LXM family of algorithms for pseudorandom number generators;
         * for more information, see the documentation for namespace
         * @b random.  Each instance of @b L128X1024MixRandom
         * has 256 bits of state plus one 128-bit instance-specific parameter.
         * </p>
         * <p>
         * If two instances of @b L128X1024MixRandom are created with
         ...
         * @b L128X1024MixRandom are <em>not</em> thread-safe.  They are
         ...
         * </p>
         */
        class L128X1024MixRandom final : public RandomGenerator {
            /*
             ...
             * that the values generated by two instances of @b L128X1024MixRandom
        ...
        public:
             ...
             */
            CORE_EXPLICIT L128X1024MixRandom(glong ah, glong al, glong sh, glong sl,
            ...
            /**
             * Creates a new instance of @b L128X1024MixRandom using the
             * specified @c long value as the initial seed. Instances of
             * @b L128X1024MixRandom created with the same seed in the same
             * program generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L128X1024MixRandom(glong seed);

            /**
             * Creates a new instance of @b L128X1024MixRandom that is likely to
             * generate sequences of values that are statistically independent
             * of those of any other instances in the current program execution,
             * but may, and typically does, vary across program invocations.
             */
            CORE_IMPLICIT L128X1024MixRandom();

            /**
             * Creates a new instance of @b L128X1024MixRandom using the specified array of
             * initial seed bytes. Instances of @b L128X1024MixRandom created with the same
             * seed array in the same program execution generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L128X1024MixRandom(ByteArray const &seed);
