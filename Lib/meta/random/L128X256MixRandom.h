...
#ifndef L128X256MIXRANDOM_H
#define L128X256MIXRANDOM_H
...
namespace core {
    namespace random {
         ...
         * is roughly 2<sup>384</sup>.  Class @b L128X256MixRandom implements
         ...
         * as well as methods for creating new split-off @b L128X256MixRandom
         * objects or streams of such objects.
         * <p>
         * The @b L128X256MixRandom algorithm is a specific member of
         * the LXM family of algorithms for pseudorandom number generators;
         * for more information, see the documentation for namespace
         * @b random.  Each instance of @b L128X256MixRandom
         * has 384 bits of state plus one 128-bit instance-specific parameter.
         * </p>
         * <p>
         * If two instances of @b L128X256MixRandom are created with
         ...
         * @b L128X256MixRandom are <em>not</em> thread-safe.  They are
         ...
         * </p>
         */
        class L128X256MixRandom final : public RandomGenerator {
            /*
             ...
             * that the values generated by two instances of @b L128X256MixRandom
             ...
             */
            static CORE_FAST gint EQUIDISTRIBUTION = 1;
             ...
             */
            glong mutable sh = 0, sl = 0, x[4] = {0, 0};
        ...
        public:
             ...
             */
            CORE_EXPLICIT L128X256MixRandom(glong ah, glong al, glong sh, glong sl,
                                            glong x0, glong x1, glong x2, glong x3);

            /**
             * Creates a new instance of @b L128X256MixRandom using the
             * specified @c long value as the initial seed. Instances of
             * @b L128X256MixRandom created with the same seed in the same
             * program generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L128X256MixRandom(glong seed);

            /**
             * Creates a new instance of @b L128X256MixRandom that is likely to
             * generate sequences of values that are statistically independent
             * of those of any other instances in the current program execution,
             * but may, and typically does, vary across program invocations.
             */
            CORE_IMPLICIT L128X256MixRandom();

            /**
             * Creates a new instance of @b L128X256MixRandom using the specified array of
             * initial seed bytes. Instances of @b L128X256MixRandom created with the same
             * seed array in the same program execution generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L128X256MixRandom(ByteArray const &seed);
