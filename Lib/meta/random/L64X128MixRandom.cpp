...
namespace core {
    namespace random {
        atomic::AtomicLong L64X128MixRandom::DEFAULT_GENERATOR = atomic::AtomicLong(RandomSupport::initialSeed());

        L64X128MixRandom::L64X128MixRandom(glong a, glong s, glong x0, glong x1) : a(a | 1), s(s), x{x0, x1} {
        ...
        L64X128MixRandom::L64X128MixRandom(glong seed)
            : L64X128MixRandom(RandomSupport::mixMurmur64(seed ^= RandomSupport::SILVER_RATIO_64),
                               1,
        ...
        L64X128MixRandom::L64X128MixRandom()
            : L64X128MixRandom(DEFAULT_GENERATOR.getAndAdd(RandomSupport::GOLDEN_RATIO_64)) {
        }

        L64X128MixRandom::L64X128MixRandom(ByteArray const &seed) {
        ...
        glong L64X128MixRandom::nextLong() const {
        ...
        gbool L64X128MixRandom::isDeprecated() const {
            return false;
        }

        RandomGeneratorProperties L64X128MixRandom::properties() const {
            return RandomGeneratorProperties("L64X128MixRandom"_S, "LXM"_S, 128, 1, 64, 2);
        }

        void L64X128MixRandom::setSeed(glong seed) {
            *this = L64X128MixRandom(seed);
        }
    } // random
} // core
