...
#ifndef CORE24_WEEL512A
#define CORE24_WEEL512A
...
namespace core {
    namespace random {
         ...
         */
        class Well512a final : public RandomGenerator {
            /**
            ...
            static CORE_FAST gint K = 512;

            /** First parameter of the algorithm. */
            static CORE_FAST gint M1 = 13;

            /** Second parameter of the algorithm. */
            static CORE_FAST gint M2 = 9;

            /** Third parameter of the algorithm. */
            static CORE_FAST gint M3 = 5;
        ...
        public:
             ...
             *
             */
            CORE_IMPLICIT Well512a();

            /**
             * Creates a new random number generator using a single int seed.
             * @param seed the initial seed (32 bits integer)
             */
            CORE_EXPLICIT Well512a(gint seed);
             ...
             */
            CORE_EXPLICIT Well512a(IntArray const &seed);

            /**
             * Creates a new random number generator using a single long seed.
             * @param seed the initial seed (64 bits integer)
             */
            CORE_EXPLICIT Well512a(glong seed);
