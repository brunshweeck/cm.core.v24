...
#ifndef CORE24_L64X128MIXRANDOM_H
#define CORE24_L64X128MIXRANDOM_H
...
namespace core {
    namespace random {
         ...
         * is roughly 2<sup>192</sup>.  Class @b L64X128MixRandom implements
         ...
         * as well as methods for creating new split-off @b L64X128MixRandom
         * objects or streams of such objects.
         *
         * <p>
         * The @b L64X128MixRandom algorithm is a specific member of
         * the LXM family of algorithms for pseudorandom number generators;
         * for more information, see the documentation for namespace
         * @b random.  Each instance of @b L64X128MixRandom
         * has 192 bits of state plus one 64-bit instance-specific parameter.
         * </p>
         * <p>
         * If two instances of @b L64X128MixRandom are created with
         ...
         * @b L64X128MixRandom are <em>not</em> thread-safe.  They are
         ...
         *
         */
        class L64X128MixRandom final : public RandomGenerator {
            /*
             ...
             * that the values generated by two instances of @b L64X128MixRandom
             ...
             * random::secureRandomSeed property is set. This serves as a
        ...
        public:
             ...
             */
            CORE_EXPLICIT L64X128MixRandom(glong a, glong s, glong x0, glong x1);

            /**
             * Creates a new instance of @b L64X128MixRandom using the
             * specified @c long value as the initial seed. Instances of
             * @b L64X128MixRandom created with the same seed in the same
             * program generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L64X128MixRandom(glong seed);

            /**
             * Creates a new instance of @b L64X128MixRandom that is likely to
             * generate sequences of values that are statistically independent
             * of those of any other instances in the current program execution,
             * but may, and typically does, vary across program invocations.
             */
            CORE_IMPLICIT L64X128MixRandom();

            /**
             * Creates a new instance of @b L64X128MixRandom using the specified array of
             * initial seed bytes. Instances of @b L64X128MixRandom created with the same
             * seed array in the same program execution generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L64X128MixRandom(ByteArray const &seed);
...
#endif //CORE24_L64X128MIXRANDOM_H
