...
#ifndef CORE24_L64X1024MIXRANDOM_H
#define CORE24_L64X1024MIXRANDOM_H
...
namespace core {
    namespace random {
         ...
         * is roughly 2<sup>1088</sup>.  Class @b L64X1024MixRandom implements
         ...
         * as well as methods for creating new split-off @b L64X1024MixRandom
         * objects or streams of such objects.
         *
         * <p>
         * The @b L64X1024MixRandom algorithm is a specific member of
         * the LXM family of algorithms for pseudorandom number generators;
         * for more information, see the documentation for namespace
         * @b random.  Each instance of @b L64X1024MixRandom
         * has 1088 bits of state plus one 64-bit instance-specific parameter.
         * </p>
         * <p>
         * If two instances of @b L64X1024MixRandom are created with
         ...
         * @b L64X1024MixRandom are <em>not</em> thread-safe.  They are
         * designed to be split, not shared, across threads (see the @b split
         * method). For example, a @b java.util.concurrent.ForkJoinTask
         * fork/join-style computation using random numbers might include a
         * construction of the form
         * @c new Subtask(someL64X1024MixRandom.split()).fork().
         * </p>
         * <p>
         ...
         * </p>
         */
        class L64X1024MixRandom final : public RandomGenerator {
            /*
             ...
             * that the values generated by two instances of @b L64X1024MixRandom
        ...
        public:
             ...
             */
            CORE_EXPLICIT L64X1024MixRandom(glong a, glong s,
            ...
            /**
             * Creates a new instance of @b L64X1024MixRandom using the
             * specified @c long value as the initial seed. Instances of
             * @b L64X1024MixRandom created with the same seed in the same
             * program generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L64X1024MixRandom(glong seed);

            /**
             * Creates a new instance of @b L64X1024MixRandom that is likely to
             * generate sequences of values that are statistically independent
             * of those of any other instances in the current program execution,
             * but may, and typically does, vary across program invocations.
             */
            CORE_IMPLICIT L64X1024MixRandom();

            /**
             * Creates a new instance of @b L64X1024MixRandom using the specified array of
             * initial seed bytes. Instances of @b L64X1024MixRandom created with the same
             * seed array in the same program execution generate identical sequences of values.
             *
             * @param seed the initial seed
             */
            CORE_EXPLICIT L64X1024MixRandom(ByteArray const &seed);
...
#endif //CORE24_L64X1024MIXRANDOM_H
