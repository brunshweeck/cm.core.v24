...
namespace core {
    namespace random {
         ...
         */
        class Well19937c final : public RandomGenerator {
            /**
        ...
        public:
             ...
             *
             */
            CORE_IMPLICIT Well19937c();

            /**
             * Creates a new random number generator using a single int seed.
             * @param seed the initial seed (32 bits integer)
             */
            CORE_EXPLICIT Well19937c(gint seed);
             ...
             */
            CORE_EXPLICIT Well19937c(IntArray const &seed);

            /**
             * Creates a new random number generator using a single long seed.
             * @param seed the initial seed (64 bits integer)
             */
            CORE_EXPLICIT Well19937c(glong seed);
