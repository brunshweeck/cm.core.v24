...
namespace core {
    namespace random {
         ...
         */
        class Well1024a final : public RandomGenerator {
            /**
            ...
            static CORE_FAST gint K = 1024;

            /** First parameter of the algorithm. */
            static CORE_FAST gint M1 = 3;

            /** Second parameter of the algorithm. */
            static CORE_FAST gint M2 = 23;

            /** Third parameter of the algorithm. */
            static CORE_FAST gint M3 = 10;
        ...
        public:
             ...
             *
             */
            CORE_IMPLICIT Well1024a();

            /**
             * Creates a new random number generator using a single int seed.
             * @param seed the initial seed (32 bits integer)
             */
            CORE_EXPLICIT Well1024a(gint seed);
             ...
             */
            CORE_EXPLICIT Well1024a(IntArray const &seed);

            /**
             * Creates a new random number generator using a single long seed.
             * @param seed the initial seed (64 bits integer)
             */
            CORE_EXPLICIT Well1024a(glong seed);
