...
namespace core {
    namespace random {
         ...
         */
        class Well44497b final : public RandomGenerator {
            /**
        ...
        public:
             ...
             *
             */
            CORE_IMPLICIT Well44497b();

            /**
             * Creates a new random number generator using a single int seed.
             * @param seed the initial seed (32 bits integer)
             */
            CORE_EXPLICIT Well44497b(gint seed);
             ...
             */
            CORE_EXPLICIT Well44497b(IntArray const &seed);

            /**
             * Creates a new random number generator using a single long seed.
             * @param seed the initial seed (64 bits integer)
             */
            CORE_EXPLICIT Well44497b(glong seed);
