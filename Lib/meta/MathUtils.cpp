...
namespace core {
    ...
    static CORE_FAST glong powersOfTeen[] = {
        1LL,
        10LL,
        100LL,
        1000LL,
    ...
    glong MathUtils::powerOfTeen(gint e) {
        return powersOfTeen[e];
    }

    int MathUtils::flog10pow2(int e) {
        return (int) (e * C_10 >> Q_10);
    }

    int MathUtils::flog10threeQuartersPow2(int e) {
        return (int) (e * C_10 + A_10 >> Q_10);
    }

    int MathUtils::flog2pow10(int e) {
    ...
    glong MathUtils::g1(int k) {
        return g[k - K_MIN << 1];
    }

    glong MathUtils::g0(int k) {
