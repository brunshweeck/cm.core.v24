...
namespace core {
    ...
    gbool CharacterData0E::isEmoji(gint ch) {
        return (propertiesEx(ch) & 0x0040) != 0;
    }

    gbool CharacterData0E::isEmojiPresentation(gint ch) {
        return (propertiesEx(ch) & 0x0080) != 0;
    }

    gbool CharacterData0E::isEmojiModifier(gint ch) {
        return (propertiesEx(ch) & 0x0100) != 0;
    }

    gbool CharacterData0E::isEmojiModifierBase(gint ch) {
        return (propertiesEx(ch) & 0x0200) != 0;
    }

    gbool CharacterData0E::isEmojiComponent(gint ch) {
        return (propertiesEx(ch) & 0x0400) != 0;
    }

    gbool CharacterData0E::isExtendedPictographic(gint ch) {
