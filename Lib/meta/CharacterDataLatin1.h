...
#ifndef CORE24_CHARACTERDATALATIN1_H
#define CORE24_CHARACTERDATALATIN1_H
...
namespace core {
    /** The CharacterData class encapsulates the large tables found in Character. */
    class CharacterDataLatin1 final : public CharacterData {
...
#endif //CORE24_CHARACTERDATALATIN1_H
