...
#include "LocaleIsoData.h"

namespace core {
    namespace util {
        String const LocaleISOData::ISO639Languages =
                "aa" "aar" // Afar
                "ab" "abk" // Abkhazian
                "ae" "ave" // Avestan
                "af" "afr" // Afrikaans
        ...
        String const LocaleISOData::ISO3166Countries =
        ...
        String const LocaleISOData::ISO3166Regions =
                ...
                "WKUM" "YDYE" "YUCS" "ZRCD" ""_S;

        String const LocaleISOData::NumericalCounties =
                "001"
                "002"
                "003"
                "005"
        ...
        String const LocaleISOData::ISOScripts =
                "Zzzz" // any
                "Adlm" // Adlam
                "Ahom" // Ahom
