...
#ifndef CORE24_JIS_X_MS932_H
#define CORE24_JIS_X_MS932_H

#include <core/charset/Charset.h>

namespace core {
    namespace charset {
        class JIS_X_0208_MS932 final : public Charset {
        public:
            CORE_IMPLICIT JIS_X_0208_MS932();
