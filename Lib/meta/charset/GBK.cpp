...
namespace core {
    namespace charset {
        GBK::GBK(): Charset("GBK"_S, StringArray::of("windows-936"_S, "CP936"_S)) {
        }

        gbool GBK::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII"_S) || Class<GBK>::hasInstance(cs);
        }

        CharsetDecoder &GBK::newDecoder() const {
            try {
        ...
        CharsetEncoder &GBK::newEncoder() const {
            try {
        ...
        String GBK::Holder::b2cSBStr = {};
        StringArray GBK::Holder::b2cStr = {};
        CharArray2D GBK::Holder::b2c = {};
        CharArray GBK::Holder::b2cSB = {};
        CharArray GBK::Holder::c2b = {};
        CharArray GBK::Holder::c2bIndex = {};
        gint GBK::Holder::initDecoderStatus = 123456789;
        gint GBK::Holder::initEncoderStatus = 123456789;

        void GBK::Holder::loadDecoderData() {
            if (initDecoderStatus == 123456789 && initEncoderStatus == 123456789) {
                try {
                    #include <meta/charset/GBK.db>
                    ...
                    Error("Unable to load GBK Decoder table"_S, ex).throws($ftrace());
                }
        ...
        void GBK::Holder::loadEncoderData() {
            if (initEncoderStatus == 123456789) {
                try {
                    ...
                    Error("Unable to load GBK Encoder table"_S, ex).throws($ftrace());
                }
